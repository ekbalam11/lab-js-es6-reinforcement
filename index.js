...
const getUsersCreditDetails = arr => {
  ...
  // 1. guarda en en 3 variables aquellas propiedades que te piden
  for (user of arr) {
    const {fName, lastName, balance} = user;
    userCreditDetails.push( fName, lastName, balance);
  }
  // 2. Añade un objeto con estas propiedad al array que debes retornar
  return userCreditDetails;
};

console.log("credit details: ", getUsersCreditDetails(usersArray));
// expected output:
...
console.log("It 4: ",genderView(usersArray));
// expected output:
// {
